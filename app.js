...
(function() {
  var Activity, Article, Bit, ObjectId, _, accessLogStream, app, async, config, express, favicon, fs, gm, marked, moment, mongoose, morgan, path, pdc, temp, util;
  ...
  accessLogStream = fs.createWriteStream(__dirname + '/log/access.log', {
    flags: 'a'
  });
